...
const MainPage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get('https://tutedude-ray7.onrender.com/friends/recommend-friends', {
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      })
  ...
  const handleSearchChange = (e) => {
    ...
    axios
      .get(`https://tutedude-ray7.onrender.com/friends/search?query=${query}`, {
        headers: {
  ...
  const sendFriendRequest = (receiverId) => {
    ...
    axios
      .post('https://tutedude-ray7.onrender.com/friends/send-request', 
        { receiverId }, 
        {
          headers: {
            'Authorization': `Bearer ${token}`,
